...
ax2.plot(sample_indices, predictions[:, 0], 'b-', label='Prediction', alpha=0.7, linewidth=2)
...
ax3.plot(sample_indices, predictions[:, 1], 'g-', label='Prediction', alpha=0.7, linewidth=2)
